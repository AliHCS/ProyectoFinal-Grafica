...
void display(Shader shader, Shader text, Model Pista, Model piso, Model CrucePista, Model Moto, Model pci, Model edifprueba, Model edif1,
	...
	Model avion, Model akira, Model ave, Model alaDer, Model alaIzq, Model Cuerpo, Model BraDer, Model BraIzq, Model PieDer, Model PieIzq)
{
	...
	model = glm::translate(model, glm::vec3(-1.6f, -2.0f, -25.81f));
	model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
	shader.setMat4("model", model);
	CrucePista.Draw(shader); // Cruce 2
	...
	model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
	shader.setMat4("model", model);
	CrucePista.Draw(shader); // Cruce 1

	//model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	//model = glm::translate(model, glm::vec3(10.0f, -2.0f, -1.5f));
	//model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
	//shader.setMat4("model", model);
	//edifprueba.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.0f, -2.0f, -3.5f));//Cruce entre los edificios
	...
	shader.setMat4("model", model);
	edif9.Draw(shader); // edificio del otro lado

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(2.0f, -2.0f, -3.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif8.Draw(shader); //edificio del otro lado

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.0f, -2.0f, -3.0f));
	model = glm::scale(model, glm::vec3(6.0f, 6.0f, 6.0f));
	shader.setMat4("model", model);
	edif6.Draw(shader); // //edificio del otro lado

	//Cruce

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(20.0f, -2.0f, -2.5f));
	model = glm::scale(model, glm::vec3(0.40f, 0.40f, 0.40f));
	shader.setMat4("model", model);
	edif1.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.0f, -2.0f, -2.5f));
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, 0.60f));
	shader.setMat4("model", model);
	edif2.Draw(shader); // Cruce 1
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(22.0f, -2.0f, -4.0f));
	model = glm::scale(model, glm::vec3(0.80f, 0.80f, 0.80f));
	shader.setMat4("model", model);
	edif5.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(23.0f, -2.0f, -3.0f));
	model = glm::scale(model, glm::vec3(6.0f, 6.0f, 6.0f));
	shader.setMat4("model", model);
	edif6.Draw(shader); // Cruce 1
	//Cruce entre dos edificios
	//model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	//model = glm::translate(model, glm::vec3(28.5f, -2.0f, -3.5f));
	//model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
	//shader.setMat4("model", model);
	//edif7.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(31.0f, -2.0f, -3.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif8.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(35.0f, -2.0f, -2.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif9.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(38.0f, -2.0f, -2.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif10.Draw(shader); // Cruce 1

	//Profundidad izquierda

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(17.0f, -2.0f, -5.5f));//Cruce entre los edificios
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, 0.60f));
	shader.setMat4("model", model);
	edif2.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(8.0f, -2.0f, -8.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif8.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(270.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(15.0f, -2.0f, 7.5f));
	model = glm::scale(model, glm::vec3(0.80f, 0.80f, 0.80f));
	shader.setMat4("model", model);
	edif5.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(7.5f, -2.0f, -14.5f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif10.Draw(shader); // Cruce 1
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(7.5f, -2.0f, 2.0f));
	model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f));
	shader.setMat4("model", model);
	edif10.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(270.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.0f, -2.0f, 7.5f));
	model = glm::scale(model, glm::vec3(0.80f, 0.80f, 0.80f));
	shader.setMat4("model", model);
	edif5.Draw(shader); // Cruce 1
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(17.0f, -2.0f, 12.5f));//Cruce entre los edificios
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, 0.60f));
	shader.setMat4("model", model);
	edif2.Draw(shader); // Cruce 1
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(7.0f, -2.0f, 1.0f));
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, 0.60f));
	shader.setMat4("model", model);
	edif2.Draw(shader); // Cruce 1
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-35.0f, -2.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.80f, 0.80f, 0.80f));
	shader.setMat4("model", model);
	edif5.Draw(shader); // Linea central derecha parte final

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(43.0f, -2.0f, 1.0f));
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, 0.60f));
	shader.setMat4("model", model);
	edif2.Draw(shader); // Cruce 1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(39.0f, -2.0f, 2.0f));
	model = glm::scale(model, glm::vec3(0.40f, 0.40f, 0.40f));
	shader.setMat4("model", model);
	edif1.Draw(shader); // Cruce 1
	...
	//////////////////////////////////////////////////////Carretera parte superior

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 1.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 1.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 2.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 2.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 3.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 3.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 5.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 5.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 6.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 6.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 7.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 7.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 8.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 8.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 9.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 9.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, 11.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, 11.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	////////////////////////////////////////////////////////////Parte inferior
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -4.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -4.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -5.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -5.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -6.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -6.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -8.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -8.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -9.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -9.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -10.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -10.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -11.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -11.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -12.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -12.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(10.1f, -2.45f, -14.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9.2, -2.45f, -14.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	///////////////////////////////////////////////////////////////Derecha
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -7.05f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -7.05f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -5.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -5.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -4.55f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -4.55f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -3.3));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -3.3f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -2.05f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -2.05f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -0.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -0.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, 0.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, 0.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, 1.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, 1.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, 2.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, 2.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	//////////////////////////////////////////Izquierda
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -12.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -12.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -14.13f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -14.13f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -15.38f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -15.38f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -16.63f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -16.63f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -17.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -17.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -19.13f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -19.13f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -20.38f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -20.38f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -21.63f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -21.63f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8
	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -22.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -22.88f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	//////////////////////////////////////////////Parte superios segunda carretera

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 1.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 1.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 2.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 2.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 3.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 3.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 5.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 5.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 6.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 6.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 7.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 7.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 8.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 8.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 9.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 9.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, 11.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, 11.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	//////////////////////////////////Parte inferior segundo cruce

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -4.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -4.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -5.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -5.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -6.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -6.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -8.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -8.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -9.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -9.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -10.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -10.4f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -11.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -11.6f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -12.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -12.8f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.95f, -2.45f, -14.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(25.05f, -2.45f, -14.0f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//9
	//////////////////////Parte izquiera del segundo cruce
	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -28.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -28.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//1

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -29.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -29.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//2

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -31.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -31.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//3

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -32.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -32.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//4

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -33.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -33.7f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//5

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -34.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -34.95f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//6

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -36.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -36.2f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//7

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-2.36f, -2.45f, -37.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);

	model = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-1.46f, -2.45f, -37.45f));
	model = glm::scale(model, glm::vec3(0.15f, 0.1f, 0.1f));
	shader.setMat4("model", model);
	Pista.Draw(shader);//8
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		display(modelShader, text, Pista, pisoModel, CrucePista, modelMoto, pciModel, edifprueba, edif1, edif2, edif4, edif5, edif6, edif7, edif8, edif9, edif10,
			estadio, cieloModel, avionModel, akiraModel, aveModel, alaDerModel, alaIzqModel, Cuerpo, BrazoDer, BrazoIzq, PieDer, PieIzq);
